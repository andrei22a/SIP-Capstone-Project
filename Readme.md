...
- **client pick_up <client_name> <product_name> <amount>**: Permitir que un cliente recoja un producto.
...
- **client buy <client_name> <product_name> <amount>**: Comprar un producto y agregarlo a la cesta del cliente.
